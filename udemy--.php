    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <h2>Vocabulary</h2>
                <p>Noun vocabulary, vocabulary, all the words a person/group knows. Noun all words/phrases in a
                    language.<br> </p>
                <p><a class="btn btn-secondary" href="#" role="button">View details »</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img class="rounded-circle" src="14.jpg" alt="Generic placeholder image" width="140" height="140">
                <h2>Grammer</h2>
                <p>Grammar is simply the set of rules that a language follows to convey a meaning.Grammar is a very
                    broad term that covers more specific areas of study, syntax and
                    semantics.</p>
                <p><a class="btn btn-secondary" href="#" role="button">View details »</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img class="rounded-circle" src="11.jpg" alt="Generic placeholder image" width="140" height="140">
                <h2>Dictionary</h2>
                <p>You can learn words you don't know or are curious about using Nesso Dictionary </p> <br>
                <p><a class="btn btn-secondary" href="sozlukss.php" role="button">View details »</a></p>
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5 order-md-1">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500"
                    src="saa.jpg" data-holder-rendered="true" style="width: 500px; height: 500px;">
            </div>
        </div>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500"
                    src="5.png" data-holder-rendered="true" style="width: 500px; height: 500px;">
            </div>
        </div>
...
<br><br>-
    ...
    <div class="as ">
        ...
        <div class="a landing-item-container landing-item-gray ;" style="min-height: 0; overflow: hidden">
            <div
                class="w-50 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">

                <form method="post" action="udemy--.php" class=" black-font-color feedback-item"
                    style="font-size: 12px"> <label id="feedback-name-label" for="name-input">İsim</label>
                ...
                <span id="feedback-completed-span" class="black-font-color" style="display: none">Mesajınızı aldık. Geri
