        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link active" href="Dersler.php">Dersler</a>
                    <a class="nav-link active" href="kelimetest.php">Kelime Testi</a>
                    <a class="nav-link active" aria-current="true" href="dictionary.phps">Sözlük</a>
    ...
    <body class="bg-light">
        ...
        <div class="container">
            <div class="py-5 text-center">
                <img class="d-block mx-auto mb-4" src="5.png" alt="" width="400" height="300">
                <h2>Checkout form</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <form class="needs-validation" novalidate="">
                        ...
                        <hr class="mb-4"> 
                        <button  class="btn btn-outline-dark"  type="submit"  >Continue to checkout</button><a href="udemy--.php"></a>
                    </form>
                </div>
            </div>
